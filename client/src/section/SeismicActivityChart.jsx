    ...
    <div className="bg-[#2A2A2A] rounded-lg p-4 sm:p-6 border border-gray-800">
      <div className="mb-3 sm:mb-4">
        <h2 className="text-lg sm:text-xl font-bold text-white mb-1 sm:mb-2">
          Seismic Activity - 24 Hours
        </h2>
        <p className="text-xs sm:text-sm text-gray-400">
          Earthquake magnitude distribution over time
        </p>
      </div>

      <div className="h-48 sm:h-64 lg:h-80 bg-[#1A1A1A] rounded-lg flex items-center justify-center border border-gray-700">
