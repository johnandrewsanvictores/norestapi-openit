  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-2 bg-[#1A1A1A] border border-gray-800 rounded-lg text-white hover:bg-gray-800 transition-colors"
      ...
      <aside
        className={`
        w-64 bg-[#1A1A1A] h-screen fixed left-0 top-0 flex flex-col border-r border-gray-800 z-40
